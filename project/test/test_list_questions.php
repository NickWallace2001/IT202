...
<div class="container-fluid">
    ...
    <form method="POST" class="form-inline">
        ...
        <a class="btn btn-success" type="button" href="test_edit_survey.php?id=<?php safer_echo($sid); ?>">Back to survey</a>
    </form>
    <div class="results">
			    ...
			    <?php foreach ($results as $r): ?>
				    <div class="list-group-item">
                        <div class="row">
					        ...
					        <div class="col">
						        <a class="btn btn-warning" type="button" href="test_edit_question.php?id=<?php safer_echo($r['id']); ?>&survey_id=<?php safer_echo($sid); ?>">Edit</a>
						        <a class="btn btn-success" type="button" href="test_view_question.php?id=<?php safer_echo($r['id']); ?>&survey_id=<?php safer_echo($sid); ?>">View</a>
					        </div>
                        </div>
				    </div>
			    <?php endforeach; ?>
